...
namespace CSharpRomp.Models
{
    public partial class WideWorldImportersContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'Purchasing.SupplierCategories_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Purchasing.Suppliers_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Sales.BuyingGroups_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Sales.CustomerCategories_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Sales.Customers_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Warehouse.ColdRoomTemperatures_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Warehouse.Colors_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Warehouse.PackageTypes_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Warehouse.StockGroups_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Warehouse.StockItems_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Application.Cities_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Application.Countries_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Application.DeliveryMethods_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Application.PaymentMethods_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Application.People_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Application.StateProvinces_Archive'. Please see the warning messages.
        // Unable to generate entity type for table 'Application.TransactionTypes_Archive'. Please see the warning messages.
